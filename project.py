...
def imd_movie_picker():
    ...
    for movie in get_imd_movies('http://www.imdb.com/chart/top'):
        ...
        label2 = Label(root, text=("+str(movie_title)+"), bd="2", relief="ridge", bg="white",
                       fg="red", font=("Times", 12),
                       width=25)
        with open("fileproject.txt", "a+") as file:
...
def func1():
    if __name__ == '__main__':
        imd_movie_picker()
label0 = Label(root, text="Top 10 Random IMDB Movies", bg="white", fg="black", font=("Times", 40))
